...
- `Архивировать` — переносит старые log-файлы в `.query-analytics-archive/<timestamp>/`;
- `Удалить старые логи` — безвозвратно удаляет только старые log-файлы до выбранной даты;
